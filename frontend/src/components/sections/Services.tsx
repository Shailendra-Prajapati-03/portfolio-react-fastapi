        ...
        {services.map((service, i) => {
          ...
          return (
            <Reveal key={service.title} delay={i * 0.1}>
              <div className="group relative h-full overflow-hidden rounded-3xl border surface p-6 shadow-soft transition-[transform,box-shadow,border-color] duration-300 ease-out hover:-translate-y-1 hover:scale-[1.01] hover:border-brand-400/60 hover:shadow-card">
                {/* hover glow */}
                ...
                <div className="grid h-12 w-12 place-items-center rounded-2xl bg-gradient-to-br from-brand-500 to-accent text-white shadow-glow">
                  <Icon size={22} />
                </div>
